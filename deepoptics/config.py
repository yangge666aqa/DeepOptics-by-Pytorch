"""Default experiment parameters; importing this module creates no files."""
from deepoptics.constants import wave_length_list_400_700nm as wave_length_list
...
controlled_network_args = {'depth': 7, 'net_num': 1, 'filter_root': 32, 'image_channels': 3,
                           ...
                           'final_activation': nn.Sigmoid, 'final_output_channels': 31}
